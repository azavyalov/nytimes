...
import static com.azavyalov.nytimes.util.Util.isDebug;
...
public class DataUtils {
    ...
    public static Single<List<NewsItem>> observeNews() {
        return Single.create(new SingleOnSubscribe<List<NewsItem>>() {
            @Override
            public void subscribe(SingleEmitter<List<NewsItem>> emitter) throws Exception {
